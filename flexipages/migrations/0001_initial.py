# Generated by Django 2.2.4 on 2019-08-24 21:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_results_template', models.ForeignKey(help_text='The template used for displaying search results.', on_delete=django.db.models.deletion.PROTECT, to='flexipages.PageTemplate', verbose_name='search results template')),
                ('site', models.OneToOneField(help_text='The site to configure.', on_delete=django.db.models.deletion.CASCADE, to='sites.Site', verbose_name='site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('render_content_as_template', models.BooleanField(default=False, help_text='Indicates whether the content is interpreted and rendered as a Django template. The content is interpreted as raw HTML when disabled.', verbose_name='render content as template')),
                ...
                ('tags', models.ManyToManyField(blank=True, to='flexipages.Tag', verbose_name='tags')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, to='flexipages.Tag', verbose_name='tags')),
                ('template', models.ForeignKey(help_text='The template used to render the page.', on_delete=django.db.models.deletion.PROTECT, to='flexipages.PageTemplate', verbose_name='template')),
            ],
            options={
                'verbose_name': 'page',
